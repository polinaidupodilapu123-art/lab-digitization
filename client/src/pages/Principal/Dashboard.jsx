...
import { Users, FileText, CheckCircle, Clock, Filter, RefreshCw, LogOut, Bell } from 'lucide-react';
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      ...
      <div className="w-64 bg-white border-r border-slate-200 flex flex-col flex-shrink-0">
        <div className="p-6">
          <h2 className="text-2xl font-bold text-teal-600">Principal Portal</h2>
          <p className="text-xs text-slate-500 mt-1">AKNU Digitization Hub</p>
        </div>
